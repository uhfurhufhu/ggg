...
if (isset($update['message']['text']) && strpos($text, '/start') === 0) {
    ...
    if ($text === '/start' || $referrer_id) {
        ...
        $caption = "
            ...
            🟢  Upgrade your power and duration as you earn more RAISAAR.
            🟢 Complete daily tasks and invite friends to boost your earnings!

            How to use guide follow the link below: 
            https://ecosystem.RAISAAR.com/RAISAAR-whitepaper/about-products/RAISAAR-miner/how-to-start-mining
        ";

        // If there was a referrer, include their ID in the link
        $referralLink = $referrer_id ? "https://v2.RAISAAR.com/?ref=$referrer_id" : "https://v2.RAISAAR.com";
                ...
                'reply_markup' => json_encode([
                    'inline_keyboard' => [
                        [
                            ...
                            ['text' => 'Join Our Community', 'url' => 'https://t.me/raisaarbot']]
                    ]
                ])
            ];
